...
from app.domain.leads.db_models import Lead, LeadQuote, LeadQuoteFollowUp, generate_referral_code
...
async def grant_referral_credit(
    session: AsyncSession,
    referred_lead: Lead | None,
    *,
    booking=None,
    payment=None,
    trigger_event: str = "booking_confirmed",
) -> None:
    await marketing_service.apply_referral_conversion(
        session,
