...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "admin.workers.delete": "Archive",
        "admin.workers.delete_confirm": "Archive this worker?",
    ...
    "ru": {
        ...
        "admin.workers.delete": "Архивировать",
        "admin.workers.delete_confirm": "Архивировать сотрудника?",
