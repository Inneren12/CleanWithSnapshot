...
const FEATURE_KEY = "training.certs";

export default function TrainingCertTemplatesPage() {
      ...
      <div className="admin-page">
        ...
        <div className="card">
          <div className="card-body">
            <p className="muted">Certificate templates are disabled for your account.</p>
          </div>
        </div>
      </div>
    );
  ...
  if (visibilityReady && !canManage) {
    return (
      <div className="admin-page">
        ...
        <div className="card">
          <div className="card-body">
            <p className="muted">You need training.manage permission to access certificate templates.</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="card">
        <div className="card-header">
          <div>
            ...
            <p className="muted">Design templates for training completion certificates.</p>
          </div>
        </div>
        <div className="card-body">
