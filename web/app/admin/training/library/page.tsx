...
const FEATURE_KEY = "training.library";
      ...
      <div className="admin-page">
        ...
        <div className="card">
          <div className="card-body">
            <p className="muted">Training library is disabled for your account.</p>
          </div>
        </div>
      </div>
    );
  ...
  if (visibilityReady && !canManage) {
    return (
      <div className="admin-page">
        ...
        <div className="card">
          <div className="card-body">
            <p className="muted">You need training.manage permission to access the training library.</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="card">
        <div className="card-header">
          <div>
            ...
            <p className="muted">Central repository for training materials and resources.</p>
          </div>
        </div>
        <div className="card-body">
